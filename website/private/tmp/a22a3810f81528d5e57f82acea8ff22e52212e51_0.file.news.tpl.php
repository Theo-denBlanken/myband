...
function content_5b30d394e14aa3_87743632 (Smarty_Internal_Template $_smarty_tpl) {
...
?>
    ...
    <h2 class="article_title"><?php echo $_smarty_tpl->tpl_vars['article']->value['title'];?>
</h2>
    <h5 class="article_content">Author: <?php echo $_smarty_tpl->tpl_vars['article']->value['author'];?>
</h5>
    <h5 class="article_content">Date of publication: <?php echo $_smarty_tpl->tpl_vars['article']->value['date'];?>
</h5>
    <img class="article_content" src="<?php echo $_smarty_tpl->tpl_vars['article']->value['image'];?>
">
    <p class="article_content"><?php echo $_smarty_tpl->tpl_vars['article']->value['content'];?>
</p>
    </div>
<?php
}
